...
public class Stats {
	...
	public HashMap<Integer, StatItem> stats = new HashMap<Integer, Stats.StatItem>();
	...
	public void addSuccess(QuizzCouple qc, Kanji answer) {
		...
		init(n);
		stats.get(n).firstHandSuccess.put(qc, stats.get(n).firstHandSuccess.get(qc)+1);
	}
	...
	public void addError(QuizzCouple qc, Kanji answer, Kanji choosen) {
		...
		init(n);
		init(c);
		stats.get(n).firstHandError.put(qc, stats.get(n).firstHandError.get(qc)+1);
		stats.get(c).secondHandError.put(qc, stats.get(c).secondHandError.get(qc)+1);
	}
	...
	public Stats(String csv) {
		...
		for ( String line : lines ) {
			...
			stats.get(n).firstHandSuccess.put(QuizzCouple.KANJI_TO_MEANINGS, Integer.parseInt(items[1]));
			stats.get(n).firstHandSuccess.put(QuizzCouple.KANJI_TO_READINGS, Integer.parseInt(items[2]));
			stats.get(n).firstHandSuccess.put(QuizzCouple.READINGS_TO_KANJI, Integer.parseInt(items[3]));
			stats.get(n).firstHandSuccess.put(QuizzCouple.MEANINGS_TO_KANJI, Integer.parseInt(items[4]));
			
			stats.get(n).firstHandError.put(QuizzCouple.KANJI_TO_MEANINGS, Integer.parseInt(items[4+1]));
			stats.get(n).firstHandError.put(QuizzCouple.KANJI_TO_READINGS, Integer.parseInt(items[4+2]));
			stats.get(n).firstHandError.put(QuizzCouple.READINGS_TO_KANJI, Integer.parseInt(items[4+3]));
			stats.get(n).firstHandError.put(QuizzCouple.MEANINGS_TO_KANJI, Integer.parseInt(items[4+4]));
			
			stats.get(n).secondHandError.put(QuizzCouple.KANJI_TO_MEANINGS, Integer.parseInt(items[8+1]));
			stats.get(n).secondHandError.put(QuizzCouple.KANJI_TO_READINGS, Integer.parseInt(items[8+2]));
			stats.get(n).secondHandError.put(QuizzCouple.READINGS_TO_KANJI, Integer.parseInt(items[8+3]));
			stats.get(n).secondHandError.put(QuizzCouple.MEANINGS_TO_KANJI, Integer.parseInt(items[8+4]));
		}
	}
